...
\begin{frame}
	\frametitle{}
\includegraphics[width=11cm]{images/Accelerators.png}
\end{frame}
...
\end{equation}
\includegraphics[width=5cm]{images/cpugpu_potts.png}
...
\begin{frame}
	\frametitle{Workflow MD code}
        \begin{center}
\includegraphics[width=5cm]{images/md_interactions_scheme.png}
        \end{center}
...
\begin{frame}
	\frametitle{NAMD performance (+setcpuaffinity)}
        \begin{center}
		\includegraphics[width=9cm]{images/profiling_namd3.png}
        \end{center}
\end{frame}
